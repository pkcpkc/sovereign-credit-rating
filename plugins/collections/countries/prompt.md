...
---
[YAML frontmatter matching the Schema Specification above. Ensure type is "Country", title is "$VALUE", timestamp is "$TIMESTAMP", and other fields match the schema.]
---
